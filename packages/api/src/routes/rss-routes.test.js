...
describe("The RSS file endpoint", function () {
    ...
    describe("The endpoint for getting perosnal RSS-feeds", function () {
        ...
        it("Should pass", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, supertest_1["default"](app_1.app).get("/articles")];
                    case 1:
                        status = (_a.sent()).status;
        ...
        it("Does return UNAUTHORZED if no user id is specified", function () { return __awaiter(void 0, void 0, void 0, function () {
            var status;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getFeed(null)];
                    case 1:
                        status = (_a.sent()).status;
        ...
        it("Does application/rss+xml on successful request", function () { return __awaiter(void 0, void 0, void 0, function () {
            var headers;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getFeed()];
        ...
        it("Does convert an rss field containint the data from all articles", function () { return __awaiter(void 0, void 0, void 0, function () {
