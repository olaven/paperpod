...
describe("The database interface for articles", function () {
  describe("Getting articles by id", function () {
    it("Does get an article", function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                articles_1.persist(common_1.test.mocks.article()),
              ];
            case 1:
              persisted = _a.sent();
    ...
    it("Does not return another aticle if there are multiple present", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var persisted, retrieved;
        return __generator(this, function (_a) {
          switch (_a.label) {
    ...
    it("Does return a defined article", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var persisted, retrieved;
        return __generator(this, function (_a) {
          switch (_a.label) {
  ...
  describe("Deleting an article by id", function () {
    it("Does actually remove on delete", function () {
      return __awaiter(void 0, void 0, void 0, function () {
