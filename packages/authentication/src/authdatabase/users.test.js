...
describe("The database interface for users", function () {
  describe("Persisting users", function () {
    ...
    it("Is possible to retrieve the user after persisting", function () {
  ...
  describe("Retrieving users by email", function () {
    it("Does return a user with the same email", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var persisted, retrieved;
        return __generator(this, function (_a) {
          switch (_a.label) {
    ...
    it("Does not return other users, even though they are present", function () {
      return __awaiter(void 0, void 0, void 0, function () {
  ...
  describe("Deleting users", function () {
    it("Is possible to delete a user", function () {
      return __awaiter(void 0, void 0, void 0, function () {
