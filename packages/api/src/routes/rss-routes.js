...
exports.rssRoutes = express_1["default"]
    .Router()
    /**
     * NOTE:
     ...
     */
    .get("/feeds/:user_id/", function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var user_id, articles, feed;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                user_id = request.params.user_id;
                if (!user_id || user_id === "null" || user_id === "undefined")
                    return [2 /*return*/, response.status(node_kall_1.UNAUTHORIZED).send()];
                return [4 /*yield*/, database.articles.getByOwner(user_id)];
            case 1:
                articles = _a.sent();
                feed = converter_1.getRSSFeed(articles);
                return [2 /*return*/, response
                        .status(node_kall_1.OK)
