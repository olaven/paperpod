    ...
    server_1.middleware.withAuthentication(function (request, response, user) {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, database.articles.getByOwner(user.id)];
            case 1:
              articles = _a.sent();
          ...
          switch (_a.label) {
            case 0:
              ...
              if (!id)
                return [
                  2 /*return*/,
                  response.status(node_kall_1.BAD_REQUEST).end(),
                ];
            ...
            case 1:
              ...
              if (!article)
                return [
                  2 /*return*/,
                  response.status(node_kall_1.NOT_FOUND).end(),
                ];
              if (article.owner_id !== user.id)
                return [
                  2 /*return*/,
                  response.status(node_kall_1.FORBIDDEN).end(),
                ];
            ...
            case 2:
              ...
              return [
                2 /*return*/,
                response.status(node_kall_1.NO_CONTENT).end(),
              ];
          }
        });
      });
